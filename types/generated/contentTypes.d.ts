...
export interface ApiDarkListDarkList extends Struct.CollectionTypeSchema {
  collectionName: 'dark_lists';
  info: {
    description: '';
    displayName: 'dark_list';
    pluralName: 'dark-lists';
...
export interface ApiNfcReaderNfcReader extends Struct.CollectionTypeSchema {
